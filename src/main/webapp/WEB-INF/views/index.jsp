...
<body>
	...
	<!--  Start with the Navigation bar with default colors  -->
		...
		<!--  The carousel at the  centre of the page with the product images -->
		...
		<!-- Indicators -->
		  ...
		  <div class="c-wrapper">
  			<div class="carousel-inner" role="listbox">
    			...
    			<div class="item">
      				<img src="${images}/Carousel_2.jpg" alt="Home Furniture">
    			</div>		
    			<div class="item">
      				<img src="${images}/Carousel_3.jpg" alt="Patio Furniture">
    			</div>		
    		</div> <!--  Carousel inner -->
    	</div> <!--  C-wrapper -->
